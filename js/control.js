function control( ) {
  ...
  var myList = JSON.parse(json);
    ...
    $("#addCampo").click(function(e) {
        ...
        $base.attr("placeholder", "<x1><x2>...<limite>");
        $base.append("<br>");
        $("#tabela").append($base);
        ...
        $.ajax({
            ...
            success: function (data) {
              ...
              myList = JSON.parse(data);
                ...
                $("#resultTable").append("<caption>Resultado</caption>");

                $("#simplexTable").empty();

                $("#simplexTable").append("<caption>Tabela Simplex</caption>");

                $("#statusTable").empty();

                $("#statusTable").append("<caption>Status</caption>");


                $("#sensTable").empty();
                $("#sensTable").append("<caption> Sensibilidade </caption>");
                ...
                if (myList.data.sens.length != 0) buildHtmlTable( '#sensTable', myList.data.sens);
